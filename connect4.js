...
function createBoard(board) {
  ...
  document.head.append(linkElement); // czemu tutaj moge uzywac "document" ktory nie istnieje w tym skrypcie?

  for (let column = 0; column < 7; column++) {
    // div: fragment stronki, container
    const columnElement = document.createElement("div"); // czemu wielokrotnie tworze consty o tej samej nazwie
